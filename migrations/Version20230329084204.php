...
final class Version20230329084204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contents (id INT NOT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, prewiew_img VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(50) NOT NULL, src VARCHAR(350) DEFAULT NULL, content TEXT NOT NULL, description VARCHAR(255) NOT NULL, slug VARCHAR(350) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(id))');
